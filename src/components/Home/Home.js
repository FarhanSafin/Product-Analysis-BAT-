...
const Home = () => {
    ...
    return (
        ...
        <section className='flex'>
            ...
            <div className='mt-52'>
            <h2 className='text-8xl hover:text-orange-300'>The Best Place</h2>
            <h2 className='text-3xl mt-10'>To buy your next <span className='underline text-rose-600 uppercase text-5xl'>favourite</span> Bat</h2>
            <p className='mt-10 mr-24'>A cricket bat is a special bit of kit used by batters to smash the ball in the sport of cricket. A cricket bat is a special bit of kit used by batters to smash the ball in the sport of cricket. It normally consists of a cane handle coupled to a flat-fronted willow-wood blade. A hitter who is making ground can also utilize it to avoid a run out by gripping the bat and tapping the ground with it.</p>
        ...
        <section>
            <h2 className='mt-48 text-3xl underline text-rose-600'>Customer Review: {sliced.length}</h2>
